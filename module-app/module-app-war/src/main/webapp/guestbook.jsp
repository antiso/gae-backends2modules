...
%>
<p>Using module: <%=modulesApi.getVersionHostname("module-app-memdb", null) %>.</p>
<%
 ...
 */    
    ...
    URL backendUrl = new URL("http://" + modulesApi.getVersionHostname("module-app-memdb", null)+"/memdb?guestbookName=" + guestbookName);
    try {
